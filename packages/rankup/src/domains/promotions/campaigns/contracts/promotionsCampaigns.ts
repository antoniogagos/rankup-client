...
export interface IPromotionsCampaignsService {
...
export const IPromotionsCampaignsService = createDecorator<IPromotionsCampaignsService>('promotionsCampaignsService');
