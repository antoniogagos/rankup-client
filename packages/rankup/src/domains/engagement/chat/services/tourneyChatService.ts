import type { ITourneyChatService } from '../contracts/tourneyChat.js';
import type { ITourneyChatGateway as TourneyChatGateway } from '../contracts/tourneyChatGateway.js';
import { ITourneyChatGateway } from '../contracts/tourneyChatGateway.js';
...
export class TourneyChatService implements ITourneyChatService {
	public constructor(@ITourneyChatGateway private readonly gateway: TourneyChatGateway) {}
