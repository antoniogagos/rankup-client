...
export interface IRankedLeaderboardsService {
...
export const IRankedLeaderboardsService = createDecorator<IRankedLeaderboardsService>('rankedLeaderboardsService');
