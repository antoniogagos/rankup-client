...
export interface ITournamentSubmissionsGateway {
...
export const ITournamentSubmissionsGateway = createDecorator<ITournamentSubmissionsGateway>('tournamentSubmissionsGateway');
