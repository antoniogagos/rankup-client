...
export interface ITournamentSubmissionsService {
...
export const ITournamentSubmissionsService = createDecorator<ITournamentSubmissionsService>('tournamentSubmissionsService');
