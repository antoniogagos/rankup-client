...
export interface ITournamentMatchdaysService {
...
export const ITournamentMatchdaysService = createDecorator<ITournamentMatchdaysService>('tournamentMatchdaysService');
