...
export interface ITournamentInvitationCodesGateway {
...
export const ITournamentInvitationCodesGateway = createDecorator<ITournamentInvitationCodesGateway>('tournamentInvitationCodesGateway');
