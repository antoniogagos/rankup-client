...
export interface ITourneyInvitationCodesGateway {
...
export const ITourneyInvitationCodesGateway = createDecorator<ITourneyInvitationCodesGateway>('tourneyInvitationCodesGateway');
