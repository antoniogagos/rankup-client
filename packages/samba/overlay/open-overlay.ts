...
type HostEventsMap<T extends ReactiveElement, K extends IEventsMap = HTMLElementEvents> = EventsMap<OverlayController<T, K>>;
...
export function openOverlay<T extends CustomElementClass, Params = null>(elementName: string, params?: Params, overlayOptions?: Options<T, HostEventsMap<T>>) {
