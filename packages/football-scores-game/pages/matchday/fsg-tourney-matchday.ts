import '../../components/tourney-matchday/fsg-tourney-matchday-live.js';
import '../../components/tourney-matchday/fsg-tourney-matchday-not-started.js';
...
@customElement('fsg-tourney-matchday')
export class FsgTourneyMatchday extends LitElement {
				...
				complete: fixture =>
					hasMatchdayStarted(fixture)
						? html`
								...
								<fsg-tourney-matchday-live .fixture=${fixture}></fsg-tourney-matchday-live>
						  `
						: html`
								<header>
									<button class="matchday-select f4 text-bold">
								...
								<fsg-tourney-matchday-not-started
									.fixture=${fixture}></fsg-tourney-matchday-not-started>
						  `,
			})}
		`;
	}
...
declare global {
	interface HTMLElementTagNameMap {
		'fsg-tourney-matchday': FsgTourneyMatchday;
	}
}
