 ...
 */
@customElement('fsg-tourney-ranking')
export class FsgTourneyRanking extends LitElement {
	...
	static styles = [
		...
		css`
			...
			/* row season winner + fsg-tourney-header height */
...
declare global {
	interface HTMLElementTagNameMap {
		'fsg-tourney-ranking': FsgTourneyRanking;
	}
}
