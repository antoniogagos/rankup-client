...
let RkSbRules = class RkSbRules extends LitElement {
    _onGoBackClick() {
        window.history.back();
    }
    _onGoBackKeydown() {
    ...
    render() {
      ...
      <main>
        ...
        <p class="f3 mt-4 mb-4">
          ${msg(`Al finalizar cada partido, se calcularán los puntos para ese partido.
...
RkSbRules = __decorate([
    customElement('rk-sb-rules')
], RkSbRules);
export { RkSbRules };
//# sourceMappingURL=rk-sb-rules.js.map