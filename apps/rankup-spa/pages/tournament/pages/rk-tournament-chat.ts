...
@customElement('rk-tournament-chat')
export class RkTournamentChat extends LitElement {
	...
	override render() {
		return html`
			...
			<div class="input-container">
				...
				<input id="textInput" type="text" @keydown=${this._handleTextInput} @change=${this._handleTextInput} class="form-control" placeholder=${msg('Escribe un mensaje aquí', { id: 'apps.rankup.spa.pages.tournament.pages.rk.tournament.chat.msg.l66c141' })} />
			</div>
		`;
	}
...
declare global {
	interface HTMLElementTagNameMap {
		'rk-tournament-chat': RkTournamentChat;
	}
}
