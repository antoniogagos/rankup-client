import { mapDuelPage, mapMyTournamentPage, mapTournament, mapTournamentPreview } from './tournament-mappers.js';
import type * as Api from '@rankup/api';
import type { ITournamentCoreGateway } from '@rankup/rankup/domains/tournaments/core/contracts/tournamentCoreGateway.js';
import type * as Domain from '@rankup/rankup/domains/tournaments/core/contracts/types.js';

export const operationOwners = {
	archiveTournament: 'api.tournament.core.archiveTournament',
	createDuel: 'api.tournament.core.createDuel',
	createDuelRematch: 'api.tournament.core.createDuelRematch',
	createTournament: 'api.tournament.core.createTournament',
	deleteTournament: 'api.tournament.core.deleteTournament',
	getTournament: 'api.tournament.core.getTournament',
	getTournamentPreview: 'api.tournament.core.getTournamentPreview',
	getTournamentRules: 'api.tournament.core.getTournamentRules',
	listDiscoverableTournaments: 'api.tournament.core.listDiscoverableTournaments',
	listMyDuels: 'api.tournament.core.listMyDuels',
	listMyTournaments: 'api.tournament.core.listMyTournaments',
	lockTournament: 'api.tournament.core.lockTournament',
	transferTournamentOwnership: 'api.tournament.core.transferTournamentOwnership',
	unarchiveTournament: 'api.tournament.core.unarchiveTournament',
	unlockTournament: 'api.tournament.core.unlockTournament',
	updateTournament: 'api.tournament.core.updateTournament',
} as const;
...
export class TournamentCoreGateway implements ITournamentCoreGateway {
