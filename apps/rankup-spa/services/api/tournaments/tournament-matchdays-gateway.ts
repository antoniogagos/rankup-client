import { mapMatchdayAvailability, mapTournamentMatchday, mapTournamentMatchdayPage, mapTournamentMatchPage } from './tournament-mappers.js';
import type * as Api from '@rankup/api';
import type { ITournamentMatchdaysGateway } from '@rankup/rankup/domains/tournaments/matchdays/contracts/tournamentMatchdaysGateway.js';
import type * as Domain from '@rankup/rankup/domains/tournaments/matchdays/contracts/types.js';

export const operationOwners = {
	getTournamentMatchday: 'api.tournament.matchdays.getTournamentMatchday',
	getTournamentMatchdayAvailability: 'api.tournament.matchdays.getTournamentMatchdayAvailability',
	listTournamentMatchdayMatches: 'api.tournament.matchdays.listTournamentMatchdayMatches',
	listTournamentMatchdays: 'api.tournament.matchdays.listTournamentMatchdays',
} as const;
...
export class TournamentMatchdaysGateway implements ITournamentMatchdaysGateway {
