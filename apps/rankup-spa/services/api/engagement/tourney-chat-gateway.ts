...
import type { ITourneyChatGateway } from '@rankup/rankup/domains/engagement/chat/contracts/tourneyChatGateway.js';
...
export class TourneyChatGateway implements ITourneyChatGateway {
